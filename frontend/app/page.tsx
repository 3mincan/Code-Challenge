        ...
        <Section spacing="hero" tone="navy">
          <Container>
            <Stack className="items-center gap-8 text-center">
              <Badge variant="tag-purple">Foundation</Badge>
              <Stack className="items-center gap-5">
                ...
                <Text variant="subtitle" tone="inverse-muted" measure="lg">
                  Editorial type, warm surfaces, tactile controls, and
                  tablet-first layout rules are in place before feature work
                  begins.
                </Text>
              </Stack>
          ...
          <Container>
            <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              <Stack className="gap-5">
                ...
                <Text measure="lg">
                  The scale keeps display moments expressive while body text
                  stays generous and readable for recipe instructions,
                  ingredient notes, and assistant responses.
                </Text>
              </Stack>
