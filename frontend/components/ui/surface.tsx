...
const surfaceVariants = cva("text-card-foreground", {
  variants: {
    variant: {
      ...
      feature: "rounded-lg border border-hairline bg-canvas p-8",
      ...
      mint: "rounded-lg bg-tint-mint p-8 text-charcoal",
      lavender: "rounded-lg bg-tint-lavender p-8 text-charcoal",
      sky: "rounded-lg bg-tint-sky p-8 text-charcoal",
      yellow: "rounded-lg bg-tint-yellow p-8 text-charcoal",
      cream: "rounded-lg bg-tint-cream p-8 text-charcoal",
      mockup:
        "rounded-lg border border-hairline bg-canvas p-4 shadow-elevation-3",
      "hero-band": "bg-brand-navy text-on-dark",
      "cta-light": "rounded-lg bg-surface p-10 text-ink",
    },
    elevation: {
      none: "",
